...
//       .post("http://localhost:5050/api/blog/add", {
//         title: inputs.title,
...
const AddBlog = () => {
  ...
  const sendRequest = async () => {
    try {
      ...
      const data = res.data;
      toast.success("Blog posted successfully!"); // Display success message
      return data;
    } catch (error) {
      toast.error("Failed to post blog."); // Display error message
    }
  };
